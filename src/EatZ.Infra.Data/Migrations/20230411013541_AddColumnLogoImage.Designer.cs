...
namespace EatZ.Infra.Data.Migrations
{
    ...
    [Migration("20230411013541_AddColumnLogoImage")]
    partial class AddColumnLogoImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EatZ.Domain.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("EatZ.Domain.Entities.Review", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("EatZ.Domain.Entities.Review", b =>
                {
                    b.HasOne("EatZ.Domain.Entities.Order", "Order")
                        .WithOne("Review")
                        .HasForeignKey("EatZ.Domain.Entities.Review", "OrderId")
